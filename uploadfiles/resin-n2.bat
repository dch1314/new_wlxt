...
java -cp "%CLASS_PATH%" -Xms64m -Xmx512m -server -Djava.util.logging.manager=com.caucho.log.LogManagerImpl com.caucho.server.http.ResinServer -conf D:\XianProject\demo\resin\resin-n2.conf