...
public class RSATest {
	...
	public static void main(String[] args) {
		try {
			...
			String encryptText = "This is the encryptText.";
			...
			//encrypt.saveKey(keyPair, "rsakeys.ini", "rsakeys.ini");

			System.out.println("PrivateKey: " + toHexString(privateKey.getEncoded()));
			System.out.println("PublicKey: " + toHexString(publicKey.getEncoded()));
			byte[] e = encrypt.encrypt(publicKey, encryptText.getBytes());
			byte[] de = encrypt.decrypt(privateKey, e);
			System.out.println("Encrypted: " + toHexString(e));
			System.out.println("Decrypted: " + toHexString(de));
			System.out.println("Decrypted as text: " + new String(de));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
